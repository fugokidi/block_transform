...
CONFIG1=configs/configs_taran_phase1.yml
CONFIG2=configs/configs_taran_phase2.yml
CONFIG3=configs/configs_taran_phase3.yml


OUT1=train_taran_phase1.out
OUT2=train_taran_phase2.out
OUT3=train_taran_phase3.out

EVAL1=eval_taran_phase1.out
EVAL2=eval_taran_phase2.out
EVAL3=eval_taran_phase3.out

END1=trained_models/Shuffle_128/checkpoint_epoch6.pth.tar
END2=trained_models/Shuffle_224/checkpoint_epoch12.pth.tar
END3=trained_models/Shuffle_288/checkpoint_epoch15.pth.tar
