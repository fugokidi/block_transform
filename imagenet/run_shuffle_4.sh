...
CONFIG1=configs/configs_shuffle_4_phase1.yml
CONFIG2=configs/configs_shuffle_4_phase2.yml
CONFIG3=configs/configs_shuffle_4_phase3.yml


OUT1=train_shuffle_4_phase1.out
OUT2=train_shuffle_4_phase2.out
OUT3=train_shuffle_4_phase3.out

EVAL1=eval_shuffle_4_phase1.out
EVAL2=eval_shuffle_4_phase2.out
EVAL3=eval_shuffle_4_phase3.out
