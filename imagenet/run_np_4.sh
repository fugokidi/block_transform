...
CONFIG1=configs/configs_np_4_phase1.yml
CONFIG2=configs/configs_np_4_phase2.yml
CONFIG3=configs/configs_np_4_phase3.yml


OUT1=train_np_4_phase1.out
OUT2=train_np_4_phase2.out
OUT3=train_np_4_phase3.out

EVAL1=eval_np_4_phase1.out
EVAL2=eval_np_4_phase2.out
EVAL3=eval_np_4_phase3.out
