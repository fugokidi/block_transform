...
CONFIG=configs/configs_shuffle_4_eval.yml
...
# python -u eval.py $DATA -c $CONFIG --resume $END --attack ead --batch-size 32

# python -u eval.py $DATA -c $CONFIG --resume $END --attack cw --batch-size 32
